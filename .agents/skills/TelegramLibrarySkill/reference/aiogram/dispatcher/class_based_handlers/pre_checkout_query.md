...
> Source: [https://docs.aiogram.dev/en/latest/dispatcher/class_based_handlers/pre_checkout_query.html](https://docs.aiogram.dev/en/latest/dispatcher/class_based_handlers/pre_checkout_query.html)
