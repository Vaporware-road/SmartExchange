...
> Source: [https://docs.aiogram.dev/en/latest/api/types/chat_member_administrator.html](https://docs.aiogram.dev/en/latest/api/types/chat_member_administrator.html)

*class* aiogram.types.chat_member_administrator.ChatMemberAdministrator(*\**, *status: Literal[ChatMemberStatus.ADMINISTRATOR] = ChatMemberStatus.ADMINISTRATOR*, *user: [User](user.html#aiogram.types.user.User "aiogram.types.user.User")*, *can_be_edited: bool*, *is_anonymous: bool*, *can_manage_chat: bool*, *can_delete_messages: bool*, *can_manage_video_chats: bool*, *can_restrict_members: bool*, *can_promote_members: bool*, *can_change_info: bool*, *can_invite_users: bool*, *can_post_stories: bool*, *can_edit_stories: bool*, *can_delete_stories: bool*, *can_post_messages: bool | None = None*, *can_edit_messages: bool | None = None*, *can_pin_messages: bool | None = None*, *can_manage_topics: bool | None = None*, *can_manage_direct_messages: bool | None = None*, *can_manage_tags: bool | None = None*, *custom_title: str | None = None*, *\*\*extra_data: Any*)
