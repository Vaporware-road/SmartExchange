...
> Source: [https://docs.aiogram.dev/en/latest/api/types/input_rich_block_thinking.html](https://docs.aiogram.dev/en/latest/api/types/input_rich_block_thinking.html)

*class* aiogram.types.input_rich_block_thinking.InputRichBlockThinking(*\**, *type: Literal[InputRichBlockType.THINKING] = InputRichBlockType.THINKING*, *text: RichTextUnion*, *\*\*extra_data: Any*)
