...
> Source: [https://docs.aiogram.dev/en/latest/api/types/passport_element_error_file.html](https://docs.aiogram.dev/en/latest/api/types/passport_element_error_file.html)
