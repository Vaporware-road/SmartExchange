...
- [`aiogram.types.message.Message.answer_photo()`](../types/message.html#aiogram.types.message.Message.answer_photo "aiogram.types.message.Message.answer_photo")
- [`aiogram.types.message.Message.reply_photo()`](../types/message.html#aiogram.types.message.Message.reply_photo "aiogram.types.message.Message.reply_photo")
- [`aiogram.types.chat_join_request.ChatJoinRequest.answer_photo()`](../types/chat_join_request.html#aiogram.types.chat_join_request.ChatJoinRequest.answer_photo "aiogram.types.chat_join_request.ChatJoinRequest.answer_photo")
- [`aiogram.types.chat_join_request.ChatJoinRequest.answer_photo_pm()`](../types/chat_join_request.html#aiogram.types.chat_join_request.ChatJoinRequest.answer_photo_pm "aiogram.types.chat_join_request.ChatJoinRequest.answer_photo_pm")
- [`aiogram.types.chat_member_updated.ChatMemberUpdated.answer_photo()`](../types/chat_member_updated.html#aiogram.types.chat_member_updated.ChatMemberUpdated.answer_photo "aiogram.types.chat_member_updated.ChatMemberUpdated.answer_photo")
- [`aiogram.types.inaccessible_message.InaccessibleMessage.answer_photo()`](../types/inaccessible_message.html#aiogram.types.inaccessible_message.InaccessibleMessage.answer_photo "aiogram.types.inaccessible_message.InaccessibleMessage.answer_photo")
- [`aiogram.types.inaccessible_message.InaccessibleMessage.reply_photo()`](../types/inaccessible_message.html#aiogram.types.inaccessible_message.InaccessibleMessage.reply_photo "aiogram.types.inaccessible_message.InaccessibleMessage.reply_photo")
