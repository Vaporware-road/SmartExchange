...
urlpatterns = [
    ...
    path("google/", api_views.GoogleAuthAPIView.as_view(), name="api-google-auth"),
    path("otp/request/", api_views.OtpRequestAPIView.as_view(), name="api-otp-request"),
    path("otp/verify/", api_views.OtpVerifyAPIView.as_view(), name="api-otp-verify"),
