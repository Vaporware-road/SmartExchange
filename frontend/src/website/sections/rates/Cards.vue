<template>
  <WsSection
    ...
    alt
  >
    <PriceWidget variant="cards" :config="content" />
    <p v-if="note" class="ws-muted ws-rates__note">{{ note }}</p>
  </WsSection>
</template>
...
/** The board the desk is really here for; the widget does the work. */
