/**
 * Vendored from bidi-js@1.0.3 (MIT)
 * https://github.com/lojjic/bidi-js
 * Copied from npm package dist/bidi.mjs so Docker named volumes with stale node_modules
 * still resolve the Unicode bidi stack (same rationale as arabicReshaperLouy.js).
 */
