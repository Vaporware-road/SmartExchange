...
> Source: [https://docs.aiogram.dev/en/latest/api/types/inline_query_result_photo.html](https://docs.aiogram.dev/en/latest/api/types/inline_query_result_photo.html)
