...
> Source: [https://docs.aiogram.dev/en/latest/api/types/suggested_post_price.html](https://docs.aiogram.dev/en/latest/api/types/suggested_post_price.html)

*class* aiogram.types.suggested_post_price.SuggestedPostPrice(*\**, *currency: str*, *amount: int*, *\*\*extra_data: Any*)
