...
> Source: [https://docs.aiogram.dev/en/latest/dispatcher/testing.html](https://docs.aiogram.dev/en/latest/dispatcher/testing.html)
...
`aiogram.Dispatcher`. This exercises aiogram’s routing pipeline without
