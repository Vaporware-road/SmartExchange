...
> Source: [https://docs.aiogram.dev/en/latest/api/types/force_reply.html](https://docs.aiogram.dev/en/latest/api/types/force_reply.html)
...
:   Upon receiving a message with this object, Telegram clients will display a reply interface to the user (act as if the user has selected the bot’s message and tapped ‘Reply’). This can be extremely useful if you want to create user-friendly step-by-step interfaces without having to sacrifice [privacy mode](https://core.telegram.org/bots/features#privacy-mode). Not supported in channels and for messages sent on behalf of a user account.
    ...
    >
    > The last option is definitely more attractive. And if you use [`aiogram.types.force_reply.ForceReply`](#aiogram.types.force_reply.ForceReply "aiogram.types.force_reply.ForceReply") in your bot’s questions, it will receive the user’s answers even if it only receives replies, commands and mentions - without any extra work for the user.
