...
> Source: [https://docs.aiogram.dev/en/latest/api/types/chat_member_updated.html](https://docs.aiogram.dev/en/latest/api/types/chat_member_updated.html)

*class* aiogram.types.chat_member_updated.ChatMemberUpdated(*\**, *chat: [Chat](chat.html#aiogram.types.chat.Chat "aiogram.types.chat.Chat")*, *from_user: [User](user.html#aiogram.types.user.User "aiogram.types.user.User")*, *date: _datetime_serializer, return_type=int, when_used=unless - none)]*, *old_chat_member: [ChatMemberOwner](chat_member_owner.html#aiogram.types.chat_member_owner.ChatMemberOwner "aiogram.types.chat_member_owner.ChatMemberOwner") | [ChatMemberAdministrator](chat_member_administrator.html#aiogram.types.chat_member_administrator.ChatMemberAdministrator "aiogram.types.chat_member_administrator.ChatMemberAdministrator") | [ChatMemberMember](chat_member_member.html#aiogram.types.chat_member_member.ChatMemberMember "aiogram.types.chat_member_member.ChatMemberMember") | [ChatMemberRestricted](chat_member_restricted.html#aiogram.types.chat_member_restricted.ChatMemberRestricted "aiogram.types.chat_member_restricted.ChatMemberRestricted") | [ChatMemberLeft](chat_member_left.html#aiogram.types.chat_member_left.ChatMemberLeft "aiogram.types.chat_member_left.ChatMemberLeft") | [ChatMemberBanned](chat_member_banned.html#aiogram.types.chat_member_banned.ChatMemberBanned "aiogram.types.chat_member_banned.ChatMemberBanned")*, *new_chat_member: [ChatMemberOwner](chat_member_owner.html#aiogram.types.chat_member_owner.ChatMemberOwner "aiogram.types.chat_member_owner.ChatMemberOwner") | [ChatMemberAdministrator](chat_member_administrator.html#aiogram.types.chat_member_administrator.ChatMemberAdministrator "aiogram.types.chat_member_administrator.ChatMemberAdministrator") | [ChatMemberMember](chat_member_member.html#aiogram.types.chat_member_member.ChatMemberMember "aiogram.types.chat_member_member.ChatMemberMember") | [ChatMemberRestricted](chat_member_restricted.html#aiogram.types.chat_member_restricted.ChatMemberRestricted "aiogram.types.chat_member_restricted.ChatMemberRestricted") | [ChatMemberLeft](chat_member_left.html#aiogram.types.chat_member_left.ChatMemberLeft "aiogram.types.chat_member_left.ChatMemberLeft") | [ChatMemberBanned](chat_member_banned.html#aiogram.types.chat_member_banned.ChatMemberBanned "aiogram.types.chat_member_banned.ChatMemberBanned")*, *invite_link: [ChatInviteLink](chat_invite_link.html#aiogram.types.chat_invite_link.ChatInviteLink "aiogram.types.chat_invite_link.ChatInviteLink") | None = None*, *via_join_request: bool | None = None*, *via_chat_folder_invite_link: bool | None = None*, *\*\*extra_data: Any*)
